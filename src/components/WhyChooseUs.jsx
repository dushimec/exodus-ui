      ...
      <div className="flex relative flex-col items-center px-20 pt-4 pb-24 w-full bg-neutral-900 bg-opacity-50 max-md:px-5 max-md:max-w-full">
        <div className="flex flex-col max-w-full w-[950px]">
          ...
          <div className="flex  ml-8 justify-between gap-10 items-center mt-7 max-md:max-w-full">
            ...
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/9d393d690b820b385444fa81c312cabcbc100e2cfc05ba174d5c218e992479f9?placeholderIfAbsent=true&apiKey=6e51f2aa35694a21b29ab869757ebe28" alt="Feature 2" className="object-contain shrink-0 self-stretch my-auto w-36 aspect-square " />
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/7a194d8ac904f74af5c6c5de4732ebd05abb490fe021c66be21aa39935ed4394?placeholderIfAbsent=true&apiKey=6e51f2aa35694a21b29ab869757ebe28" alt="Feature 3" className="object-contain shrink-0 self-stretch my-auto w-36 aspect-square mr-8" />
          ...
          <div className="flex flex-wrap gap-5 justify-between mt-10 mr-4 ml-3.5 text-base font-medium text-white max-md:mr-2.5 max-md:max-w-full">
            ...
            <div>High qualified services</div>
          </div>
        </div>
      </div>
    </section>
