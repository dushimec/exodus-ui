    ...
    <section className="flex relative flex-col justify-center py-px mt-20 w-full min-h-[445px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] max-md:mt-10 max-md:max-w-full">
      ...
      <div className="flex relative flex-col items-center px-20 pt-4 pb-24 w-full bg-neutral-900 bg-opacity-50 max-md:px-5 max-md:max-w-full">
        <div className="flex flex-col max-w-full w-[950px]">
          ...
          <div className="flex flex-wrap gap-10 items-center mt-7 max-md:max-w-full">
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/ab42847af8ca220686e9916a9ce7128f82eeb5ab10498a9d21e3c5665b631aa9?placeholderIfAbsent=true&apiKey=6e51f2aa35694a21b29ab869757ebe28" alt="Affordable price guarantee" className="object-contain shrink-0 self-stretch my-auto w-36 aspect-square" />
            ...
            <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/7a194d8ac904f74af5c6c5de4732ebd05abb490fe021c66be21aa39935ed4394?placeholderIfAbsent=true&apiKey=6e51f2aa35694a21b29ab869757ebe28" alt="High qualified service" className="object-contain shrink-0 self-stretch my-auto w-36 aspect-square" />
          </div>
