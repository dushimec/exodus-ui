        ...
        <div className="flex flex-col w-full max-w-5xl">
          ...
          <div className="flex justify-between gap-5 sm:gap-2  w-full max-w-sm md:max-w-lg mx-auto">
            <img
              ...
              alt={t('whyChooseUs.features.affordablePrice')}
            ...
            <img
              ...
              alt={t('whyChooseUs.features.varietyDestinations')}
            ...
            <img
              ...
              alt={t('whyChooseUs.features.qualifiedService')}
          ...
          <div className="flex justify-between gap-2 sm:gap-5 mt-3 text-xs md:text-sm font-medium text-white text-center max-w-sm md:max-w-lg mx-auto">
            <div className="mx-1">{t('whyChooseUs.features.affordablePrice')}</div>
            <div className="mx-1">{t('whyChooseUs.features.varietyDestinations')}</div>
            <div className="mx-1">{t('whyChooseUs.features.qualifiedService')}</div>
          </div>
        </div>
      </div>
    </section>
