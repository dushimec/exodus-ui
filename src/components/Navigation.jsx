...
function Navigation() {
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-0 w-full bg-sky-600 text-white py-2 px-4 md:px-6 lg:px-10 xl:px-12 z-50 transition-all duration-300 ${isScrolled ? "-translate-y-full" : "translate-y-0"}`}
      >
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
              <Mail className="h-4 w-4 mr-2" />
              <span className="text-sm">Oldfoxcoltd@gmail.com
              </span>
            </div>
      ...
      <nav
        className={`fixed ${isScrolled ? "top-0" : "top-[40px]"} left-0 flex flex-wrap items-center w-full z-40 transition-all duration-300 ${
      ...
      >
        <div className="flex justify-between items-center w-full px-4 md:px-6 lg:px-10 xl:px-12 text-white">
          ...
          <div className="hidden lg:flex text-xs lg:items-center lg:gap-4 font-weight: normal xl:gap-8">
            ...
            <Link to="/products" className="text-sm lg:text-base xl:text-[16px]">
          ...
          <div className="hidden lg:flex items-center text-white lg:gap-3 xl:gap-4">
            ...
            {!user ? (
              <div className="flex gap-1.5 items-center">
                <Link to="/login" className="text-sm lg:text-base xl:text-[16px]">
                  {t("navigation.login")}
                </Link>
                <span>|</span>
                <Link to="/signup" className="text-sm lg:text-base xl:text-[16px]">
                  {t("navigation.signup")}
                </Link>
              </div>
            ) : (
