...
//     <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
//       <div className="bg-white rounded-lg p-6 w-full max-w-md">
//         <h2 className="text-2xl font-bold mb-4 text-sky-500">{t('bookingForm.title')}</h2>
//         <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
//           <div>
//             <label htmlFor="name" className="block text-sm font-medium text-gray-700">{t('bookingForm.name')}</label>
//             <input type="text" id="name" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50" placeholder={t('bookingForm.namePlaceholder')} />
//           </div>
//           <div>
//             <label htmlFor="email" className="block text-sm font-medium text-gray-700">{t('bookingForm.email')}</label>
//             <input type="email" id="email" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50" placeholder={t('bookingForm.emailPlaceholder')} />
//           </div>
//           <div>
//             <label htmlFor="travelers" className="block text-sm font-medium text-gray-700">{t('bookingForm.travelers')}</label>
//             <input type="number" id="travelers" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50" placeholder="1" min="1" />
//           </div>
//           <div>
//             <label htmlFor="date" className="block text-sm font-medium text-gray-700">{t('bookingForm.date')}</label>
//             <input type="date" id="date" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50" />
//           </div>
//           <div className="text-xl font-bold text-sky-500 mt-4">
//             {t('bookingForm.price', { price: 390 })}
//           </div>
//           <div className="flex gap-4 mt-6">
//             <button type="submit" className="flex-1 bg-sky-500 text-white py-2 px-4 rounded-md hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-opacity-50 transition duration-200">{t('bookingForm.bookNow')}</button>
//             <button onClick={onClose} className="flex-1 bg-gray-200 text-gray-800 py-2 px-4 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50 transition duration-200">{t('bookingForm.cancel')}</button>
//           </div>
//         </form>
//       </div>
//     </div>
...
//   const { t } = useTranslation();
//   const [tours, setTours] = useState([
//     { id: 1, name: t('relatedTours.tour1.name'), location: t('relatedTours.tour1.location'), likes: 100, liked: false, comments: [] },
//     { id: 2, name: t('relatedTours.tour2.name'), location: t('relatedTours.tour2.location'), likes: 50, liked: false, comments: [] }
//   ]);
...
//   return (
//     <div>
//       <div className="text-black text-xl font-bold mb-4">{t('relatedTours.title')}</div>
//       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//         {tours.map((tour) => (
//           <div key={tour.id} className="bg-white shadow-lg p-4">
//             <img
...
//                   )}
//                 </button>
//                 <span>{t('relatedTours.likes', { count: tour.likes })}</span>
//               </div>
//               <span>{t('relatedTours.price', { price: 120 })}</span>
//             </div>

//             <div className="mt-4">
//               <h4 className="text-black text-sm font-bold">{t('relatedTours.comments')}:</h4>
//               {tour.comments.length === 0 ? (
//                 <p className="text-gray-500">{t('relatedTours.noComments')}</p>
//               ) : (
//                 <ul className="text-sm text-gray-700">
//                   {tour.comments.map((comment, index) => (
//                     <li key={index} className="border-b border-gray-200 py-1">
...
//                   type="text"
//                   className="w-full h-10 border border-gray-300 px-2 mb-2"
//                   placeholder={t('relatedTours.addComment')}
//                   onKeyDown={(e) => {
//                     if (e.key === "Enter" && e.target.value.trim()) {
//                       addComment(tour.id, e.target.value);
//                       e.target.value = "";
...
//           <div>
//             <div className="text-sky-500 text-2xl font-bold mb-4">
//               {t('rwandaDescription.title')}
//             </div>
//             <p className="text-black text-lg mb-6">
//               {t('rwandaDescription.short')}
//             </p>
//             <div className="text-sky-500 text-2xl font-bold mb-4">
//               {t('rwandaDescription.fullTitle')}
//             </div>
//             <p className="text-black text-lg">
//               {t('rwandaDescription.full')}
//             </p>
//           </div>
...
//                 <p className="text-gray-600 mb-4">{destination.description}</p>
//                 <div className="flex items-center justify-between">
//                   <p className="font-semibold">{t('destination.price', { price: destination.price })}</p>
//                 </div>
//               </div>
//             ))}
//           </div>
...
//           <div>
//             <div className="text-black text-xl font-bold mb-4">
//               {t('recentlyVisited.title')}
//             </div>
//             <img
//               className="w-full h-auto"
//               src={kigali}
//               alt={t('recentlyVisited.imageAlt')}
//             />
...
//         <div className="w-full lg:w-1/3 h-auto mb-12 lg:mb-48 lg:ml-0 pb-20">
//           <div className="bg-sky-500 text-white flex justify-between items-center px-6 py-4">
//             <div className="text-lg font-semibold">{t('priceSummary.title')}</div>
//             <div className="text-3xl font-bold">{t('priceSummary.total', { total: 390 })}</div>
//           </div>

//           <div className="bg-white shadow-lg p-6">
//             <div className="bg-sky-500 text-white text-center py-3 mb-6">
//               <span className="text-base font-semibold">{t('tourSummary.title')}</span>
//             </div>
//             <div className="space-y-4">
//               {destinations.map((destination) => (
//                 <div key={destination.name} className="flex justify-between">
//                   <span>{destination.name}</span>
//                   <span>{t('destination.price', { price: destination.price })}</span>
//                 </div>
//               ))}
//               <div className="border-t pt-4 font-bold">
//                 <div className="flex justify-between">
//                   <span>{t('tourSummary.total')}</span>
//                   <span>{t('priceSummary.total', { total: 390 })}</span>
//                 </div>
//               </div>
//             </div>
...
function BookingForm({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <h2 className="text-2xl font-bold mb-4 text-sky-500">{t('rwandadetails.bookingForm.title')}</h2>
        <form onSubmit={(e) => e.preventDefault()} className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-gray-700">{t('rwandadetails.bookingForm.name')}</label>
            <input type="text" id="name" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50" placeholder={t('rwandadetails.bookingForm.namePlaceholder')} />
          </div>
          <div>
            <label htmlFor="email" className="block text-sm font-medium text-gray-700">{t('rwandadetails.bookingForm.email')}</label>
            <input type="email" id="email" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50" placeholder={t('rwandadetails.bookingForm.emailPlaceholder')} />
          </div>
          <div>
            <label htmlFor="travelers" className="block text-sm font-medium text-gray-700">{t('rwandadetails.bookingForm.travelers')}</label>
            <input type="number" id="travelers" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50" placeholder="1" min="1" />
          </div>
          <div>
            <label htmlFor="date" className="block text-sm font-medium text-gray-700">{t('rwandadetails.bookingForm.date')}</label>
            <input type="date" id="date" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-sky-300 focus:ring focus:ring-sky-200 focus:ring-opacity-50" />
          </div>
          <div className="text-xl font-bold text-sky-500 mt-4">
            {t('rwandadetails.bookingForm.price', { price: 390 })}
          </div>
          <div className="flex gap-4 mt-6">
            <button type="submit" className="flex-1 bg-sky-500 text-white py-2 px-4 rounded-md hover:bg-sky-600 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-opacity-50 transition duration-200">{t('rwandadetails.bookingForm.bookNow')}</button>
            <button onClick={onClose} className="flex-1 bg-gray-200 text-gray-800 py-2 px-4 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50 transition duration-200">{t('rwandadetails.bookingForm.cancel')}</button>
          </div>
        </form>
      </div>
    </div>
...
function RelatedTours() {
  const { t } = useTranslation();
  const [tours, setTours] = useState([
    { id: 1, name: t('rwandadetails.relatedTours.tour1.name'), location: t('rwandadetails.relatedTours.tour1.location'), likes: 100, liked: false, comments: [] },
    { id: 2, name: t('rwandadetails.relatedTours.tour2.name'), location: t('rwandadetails.relatedTours.tour2.location'), likes: 50, liked: false, comments: [] }
  ]);
  ...
  return (
    <div>
      <div className="text-black text-xl font-bold mb-4">{t('rwandadetails.relatedTours.title')}</div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {tours.map((tour) => (
          <div key={tour.id} className="bg-white shadow-lg p-4">
            <img
            ...
            <div className="flex justify-between mt-2 text-sm text-gray-500">
              <div className="flex items-center">
                ...
                <span>{t('rwandadetails.relatedTours.likes', { count: tour.likes })}</span>
              </div>
              <span>{t('rwandadetails.relatedTours.price', { price: 120 })}</span>
            </div>

            <div className="mt-4">
              <h4 className="text-black text-sm font-bold">{t('rwandadetails.relatedTours.comments')}:</h4>
              {tour.comments.length === 0 ? (
                <p className="text-gray-500">{t('rwandadetails.relatedTours.noComments')}</p>
              ) : (
                <ul className="text-sm text-gray-700">
                  {tour.comments.map((comment, index) => (
                    <li key={index} className="border-b border-gray-200 py-1">
              ...
              <div className="mt-2">
                <input
                  type="text"
                  className="w-full h-10 border border-gray-300 px-2 mb-2"
                  placeholder={t('rwandadetails.relatedTours.addComment')}
                  onKeyDown={(e) => {
                    if (e.key === "Enter" && e.target.value.trim()) {
                      addComment(tour.id, e.target.value);
                      e.target.value = "";
...
function RwandaDetails() {
  ...
  const destinations = t('rwandadetails.destinations', { returnObjects: true });
    ...
    <div className="w-full h-auto bg-stone-50 relative">
      <div className="relative w-full h-[50vh]">
        <img
          className="w-full h-full object-cover"
          src='https://cdn.builder.io/api/v1/image/assets/TEMP/ac109e70ddda2f99596b7c5e3d028a6ecd87d15434bcbc75fd434ab0f43f2d2e?placeholderIfAbsent=true&apiKey=6e51f2aa35694a21b29ab869757ebe28'
          alt={t('rwandadetails.heroImage.alt')}
        />
        <div className="absolute inset-0 bg-black/50" />
        <div className="absolute left-8 md:left-16 top-[70%] transform -translate-y-1/2 text-white text-4xl md:text-5xl font-bold">
          {t('rwandadetails.heroImage.title')}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-4 flex flex-col lg:flex-row gap-8 py-8 px-4 lg:ml-12">
        <div className="w-full lg:w-2/3 space-y-8">
          <div>
            <div className="text-sky-500 text-2xl font-bold mb-4">
              {t('rwandadetails.rwandaDescription.title')}
            </div>
            <p className="text-black text-lg mb-6">
              {t('rwandadetails.rwandaDescription.short')}
            </p>
            <div className="text-sky-500 text-2xl font-bold mb-4">
              {t('rwandadetails.rwandaDescription.fullTitle')}
            </div>
            <p className="text-black text-lg">
              {t('rwandadetails.rwandaDescription.full')}
            </p>
          </div>
          ...
          <div className="space-y-6">
            {destinations.map((destination) => (
              <div key={destination.name} className="bg-white shadow-lg rounded-lg p-6">
                ...
                <p className="text-gray-600 mb-4">{destination.description}</p>
                <div className="flex items-center justify-between">
                  <p className="font-semibold">{t('rwandadetails.destination.price', { price: destination.price })}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div>
            <div className="text-black text-xl font-bold mb-4">
              {t('rwandadetails.recentlyVisited.title')}
            </div>
            <img
              className="w-full h-auto"
              src={kigali}
              alt={t('rwandadetails.recentlyVisited.imageAlt')}
            />
        ...
        <div className="w-full lg:w-1/3 h-auto mb-12 lg:mb-48 lg:ml-0 pb-20">
          <div className="bg-sky-500 text-white flex justify-between items-center px-6 py-4">
            <div className="text-lg font-semibold">{t('rwandadetails.priceSummary.title')}</div>
            <div className="text-3xl font-bold">{t('rwandadetails.priceSummary.total', { total: 390 })}</div>
          </div>

          <div className="bg-white shadow-lg p-6">
            <div className="bg-sky-500 text-white text-center py-3 mb-6">
              <span className="text-base font-semibold">{t('rwandadetails.tourSummary.title')}</span>
            </div>
            <div className="space-y-4">
              {destinations.map((destination) => (
                <div key={destination.name} className="flex justify-between">
                  <span>{destination.name}</span>
                  <span>{t('rwandadetails.destination.price', { price: destination.price })}</span>
                </div>
              ))}
              <div className="border-t pt-4 font-bold">
                <div className="flex justify-between">
                  <span>{t('rwandadetails.tourSummary.total')}</span>
                  <span>{t('rwandadetails.priceSummary.total', { total: 390 })}</span>
                </div>
              </div>
            </div>
